import { MemoCounterComponent } from "@/components/memoCounterComponent";
import { NextPage } from "next";
import { useState } from "react";

export const NoMemoCounter:NextPage = () => {
  ...
  return (
    ...
    <MemoCounterComponent parentCount02={parentCount02} setParentCount02={setParentCount02} />
  </>
  )
}

export default NoMemoCounter;